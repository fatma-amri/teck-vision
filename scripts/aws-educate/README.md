...
- HTTP API Gateway endpoint that triggers Lambda
...
- `-FunctionName`: default `teck-vision-educate-start-instance`
...
```powershell
$body = @{ user_id = "123"; room_id = "educate-linux-01" } | ConvertTo-Json
